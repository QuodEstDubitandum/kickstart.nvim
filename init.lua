...
vim.keymap.set('n', 'g<leader>', vim.diagnostic.goto_next, { desc = 'Go to next [D]iagnostic message' })
vim.keymap.set('n', '<leader>e', vim.diagnostic.open_float, { desc = 'Show diagnostic [E]rror messages' })
vim.keymap.set('n', '<leader>q', vim.diagnostic.setloclist, { desc = 'Open diagnostic [Q]uickfix list' })

vim.keymap.set('n', '<Leader>i', ':e ~/.config/nvim/init.lua<CR>', { noremap = true, silent = true })
...
vim.keymap.set('n', '<space>st', ':Telescope file_browser path=%:p:h select_buffer=true<CR>')
-- [[ Basic Autocommands ]]
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sb', ':DBUIToggle<CR>', { desc = 'Open dadbod UI' })
